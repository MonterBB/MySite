    ...
    <?php include("../../app/include/sidebar-admin.php");?>
      <div class="products col-10">
        ...
        <div class="row title-table">
          ...
          <div class="id col-2">ID</div>
          <div class="title col-3">Название</div>
          <div class="red col-4">Управление</div>
        </div>
        <?php foreach ($topics as $key => $topic): ?>
        <div class="row product">
          <div class="id col-2"><?=$topic['id_category'];?></div>
          <div class="title col-3"><?=$topic['name_category'];?></div>
          <div class="red col-2"><a href="edit.php?id_category=<?=$topic['id_category'];?>">Редакт.</a></div>
          <div class="del col-2"><a href="edit.php?del_id=<?=$topic['id_category'];?>">Удалить</a></div>
        </div>
        <?php endforeach;?>
        </div>
      </div>
