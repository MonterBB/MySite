        ...
        <div class="mb-12 col-12 col-md-12 error">
          ...
          <form action="create.php" method="post">
              ...
              <label for="content" class="form-label">Название товара</label>
                  <input name="name_product" type="text" class="form-control" placeholder="Название" aria-label="Название товара">
              </div>
              <div class="col">
              ...
              <label for="content" class="form-label">Название изображения</label>
                  <input name="image" type="text" class="form-control" placeholder="Название изображения для товара" aria-label="Название изображения">
              </div>
              <label for="content" class="form-label">Выбор категории</label>
              <select name="id_category" class="form-select" aria-label="Категории">
                  <?php foreach ($topics as $key => $category): ?>
                    <option value="<?=$category['id_category']?>"><?=$category['name_category']?></option>
                  <?php endforeach; ?>
              </select>
              <div class="col">
                  <button name="product-create" class="btn btn-primary" type="submit">Добавить</button>
              </div>
          </form>
        </div>
      </div>
